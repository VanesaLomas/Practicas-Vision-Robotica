...
## Entorno de trabajo
  Para la realización de la página se utilizará Robotics-Academy, y en concreto el entorno web unibotics.org, donde se utiliza Python para programar la solución al ejercicio.
...
Un ejemplo en el que se incluyó velocidad variable se muestra en el siguiente vídeo, pero puede verse el coche es demasiado inestable y se desvía mucho en las curvas:
<div style="text-align: center;">
