...
Tras un largo proceso exprimental se han conseguido encontrar unos valores de Kp y Kd que permiten un equilibrio entre recorrer el circuito en el menor tiempo posible y mantenerse sobre la línea en la mayoría del circuito, haciendo que la conducción sea segura. Dicha configuración permite recorrer el circuito en 32 segundos, como puede verse en el siguiente vídeo: 
