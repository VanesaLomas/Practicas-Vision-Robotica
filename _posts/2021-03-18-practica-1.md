...
Cabe mencionar que antes de seleccionar la región de interés comentada, se probó con otras regiones que abarcasen otro conjunto de filas, pero fue con esta última con la que se obtuvieron mejores resultados. 
...
Las primeras pruebas Un ejemplo en el que se incluyó velocidad variable se muestra en el siguiente vídeo, pero como puede verse el coche es demasiado inestable y se desvía mucho en las curvas:
<div style="text-align: center;">
