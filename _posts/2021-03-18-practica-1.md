...
w = Kp * error
~~~
En la ecuación anterior Kp es una constante que se determina experimentalmente mediante prueba y error. Conviene mencionar que el signo del error se tiene que tener en cuenta ya que determina el signo de la velocidad angular e indica en qué dirección hay que girar:
